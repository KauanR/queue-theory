...
## Sobre
Aplicação web que simula a teoria das filas(simulação por modelagem análitica). Feita como requisito parcial à obtenção do grau de bacharelado na disciplina de 'Simulação - URI'.
<br/>
